...
func (x *CalculatorReq) GetA() int32 {
	if x != nil {
		return x.A
	}
	return 0
...
func (x *CalculatorReq) GetB() int32 {
	if x != nil {
		return x.B
	}
	return 0
...
func (x *CalculatorRes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CalculatorRes) ProtoMessage() {}

func (x *CalculatorRes) ProtoReflect() protoreflect.Message {
	mi := &file_calculator_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CalculatorRes.ProtoReflect.Descriptor instead.
func (*CalculatorRes) Descriptor() ([]byte, []int) {
	return file_calculator_proto_rawDescGZIP(), []int{1}
}

func (x *CalculatorRes) GetSum() int64 {
	if x != nil {
		return x.Sum
	}
	return 0
...
var file_calculator_proto_rawDesc = []byte{
	...
	,
...
var file_calculator_proto_goTypes = []interface{}{
	...
	(*CalculatorRes)(nil), // 1: calculator.CalculatorRes
}
var file_calculator_proto_depIdxs = []int32{
	0, // 0: calculator.Calculator.Sum:input_type -> calculator.CalculatorReq
	1, // 1: calculator.Calculator.Sum:output_type -> calculator.CalculatorRes
