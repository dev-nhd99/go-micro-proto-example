...
type CalculatorClient interface {
	Sum(ctx context.Context, in *CalculatorReq, opts ...grpc.CallOption) (*CalculatorRes, error)
}
...
func (c *calculatorClient) Sum(ctx context.Context, in *CalculatorReq, opts ...grpc.CallOption) (*CalculatorRes, error) {
...
func (UnimplementedCalculatorServer) Sum(context.Context, *CalculatorReq) (*CalculatorRes, error) {
...
func _Calculator_Sum_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Sum(ctx, req.(*CalculatorReq))
	}
